...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = 'https://localhost:7115'
 ...
 * @contact Bill Mei <bill.mei@somewhere.com>
 *
 * An example application with OpenAPI, Swashbuckle, and API versioning.<h4>Additional Information</h4>
 */
