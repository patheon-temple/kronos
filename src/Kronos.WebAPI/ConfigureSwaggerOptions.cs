...
// Enhanced Schema Filter for NSwag compatibility
public class EnumSchemaFilter : ISchemaFilter
{
    public void Apply(OpenApiSchema schema, SchemaFilterContext context)
    {
        if (context.Type.IsEnum)
        {
            ...
            // Add string representations of enum values
            foreach (var name in enumValues)
            {
                schema.Enum.Add(new OpenApiInteger((int)name));
            }

            // Add x-enumNames extension for NSwag
